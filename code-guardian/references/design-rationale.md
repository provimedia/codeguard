...
- **Version label moves to v12.** Real rule addition (new orthogonal gate + reference file + core rule), not a layout refactor — title becomes `Code Guardian (v12)`; `install.sh` markers updated in lockstep (`Code Guardian (v12)`, `DECISION GATE`).
